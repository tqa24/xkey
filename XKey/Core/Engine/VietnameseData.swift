...
class VietnameseData {
    ...
    let unicodeCodeTable: [UInt32: [UInt32]] = [
        ...
        // KEY_I plain with marks: Í, í, Ì, ì, Ỉ, ỉ, Ĩ, ĩ, Ị, ị
        0x80000 | UInt32(KEY_I): [0x00CD, 0x00ED, 0x00CC, 0x00EC, 0x1EC8, 0x1EC9, 0x0128, 0x0129, 0x1ECA, 0x1ECB],
        // KEY_Y plain with marks: Ý, ý, Ỳ, ỳ, Ỷ, ỷ, Ỹ, ỹ, Ỵ, ỵ
        0x80000 | UInt32(KEY_Y): [0x00DD, 0x00FD, 0x1EF2, 0x1EF3, 0x1EF6, 0x1EF7, 0x1EF8, 0x1EF9, 0x1EF4, 0x1EF5]
    ]
